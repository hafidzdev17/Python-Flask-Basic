...
class LRUCache(object):
    ...
    # scale.  But as long as it's only used as storage for template this
    # won't do any harm.
...
def select_autoescape(
    ...
    If you want to enable it for all template created from strings or
    for all template with `.html` and `.xml` extensions::
    ...
    a list of all template it should be disabled for.  If a template is
...
class Cycler(object):
    ...
    once the end is reached. Available as ``cycler`` in template.
